...
int main(){
    ...
    compare(ref,ref,n);
/////////////////////////////
     int insertab1[] = {14,15,92,65,35,89,79,32,38,46,26,43,38,32,79,50,28,84,19,71,69,39,93,75,10,58,20,97,49,44,59,23,07,81,64,06,28,62,8,99,86,28,03,48,25,34,21,17,06,79};
     int insertab2 []= {99,97,93,92,89,86,84,81,79,79,79,75,71,69,65,64,62,59,58,50,49,48,46,44,43,39,38,38,35,34,32,32,28,28,28,26,25,23,21,20,19,17,15,14,10,8,7,6,6,3};
     int insertab3 []= {3,6,6,7,8,10,14,15,17,19,81,21,23,25,26,28,28,28,32,32,34,35,38,38,39,43,44,46,48,49,50,58,59,62,64,65,69,71,75,79,79,79,20,84,86,89,92,93,97,99};
     ...
     */
    printf("Insertion Sort tab1 : Operation Counter =  %d \t",insertionSort(insertab1,n)); //// 691 operation
    compare(insertab1,ref,n);
    printf("Insertion Sort tab2 : Operation Counter =  %d \t",insertionSort(insertab2,n));////1225 operation
    compare(insertab2,ref,n);
    printf("Insertion Sort tab3 : Operation Counter =  %d \t",insertionSort(insertab3,n)); ////72 operation
    compare(insertab3,ref,n);
    ...
    if( tmp== NULL)
        return  1;
    mergeSort(mergetab1,tmp,0,n-1,&conter);
    printf("MergeSort tab1 : counter = %d \t ",conter); //////counter = 259
    compare(mergetab1,ref,n);
    conter = 0;
    mergeSort(mergetab2,tmp,0,n-1,&conter);
    printf("MergeSort tab2 : counter = %d \t ",conter); ////counter = 286
    compare(mergetab2,ref,n);
    conter = 0;
    mergeSort(mergetab3,tmp,0,n-1,&conter);
    ...
    /////////////////////////////////////
    free(tmp);
    int bonustab1[] = {14,15,92,65,35,89,79,32,38,46,26,43,38,32,79,50,28,84,19,71,69,39,93,75,10,58,20,97,49,44,59,23,07,81,64,06,28,62,8,99,86,28,03,48,25,34,21,17,06,79};
    int bonustab2[] = {99,97,93,92,89,86,84,81,79,79,79,75,71,69,65,64,62,59,58,50,49,48,46,44,43,39,38,38,35,34,32,32,28,28,28,26,25,23,21,20,19,17,15,14,10,8,7,6,6,3};
    int bonustab3[] = {3,6,6,7,8,10,14,15,17,19,81,21,23,25,26,28,28,28,32,32,34,35,38,38,39,43,44,46,48,49,50,58,59,62,64,65,69,71,75,79,79,79,20,84,86,89,92,93,97,99};

    ///////Bonus :Bubble Sort with fonction pointer asc and desc///////////////////
    printf("Bubble Sort tab 1 asc: operation counter = %d \n",custom_bulle(tab1,n,&asc));///// O(n) 682 operation
    affiche(bonustab1,n);
    printf("Bubble Sort tab 1 des: operation counter = %d \n",custom_bulle(bonustab2,n,&desc));////O(n²) 1216 operation
    affiche(bonustab2,n);
    /////////////////////////////
	return 0;
